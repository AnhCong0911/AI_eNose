...
public class GasDetectorModel {
  ...
  public static class Outputs {
    ...
    // anhcong
    public Map<String, Float> getOutputtensorsAsMap() {
      return new TensorLabel(outputtensorsLabels, postprocessOutputtensors(outputtensors)).getMapWithFloatValue();
    }
  ...
  private Object[] preprocessInputs(TensorBuffer inputtensor) {
    Log.e("preprocess Input tensors", "Before preprocessing: " + Arrays.toString(inputtensor.getFloatArray()));
    inputtensor = inputtensorPreprocessor.process(inputtensor);
    Log.e("preprocess Input tensors", "After preprocessing: " + Arrays.toString(inputtensor.getFloatArray()));
